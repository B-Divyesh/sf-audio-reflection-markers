...
| Set a source, press Mark this moment, and write the question you want your future self to answer. | 18 | `capture-marker`, `recall-cue-and-date` |
| Optional · stored in this browser | 5 | `local-voice-note` |
| Everything lives in this browser. | 5 | Local storage summary |
...
| Local media files are available only until you reload or close the page. | 13 | `local-file-session-only` |
